...
@section('title_page','Overriding Customer')
...
@section('content')
        ...
        <div class="col-md-6">
            <div class="card card-success">
                <div class="card-header">
                    <h3 class="card-title">Industry  Old</h3>
                </div>
                <div class="card-body">
            ...
            <div class="card card-primary">
                <div class="card-header">
                    <h3 class="card-title">Organization Old</h3>
                </div>
                <div class="card-body">
                    <div class="form-group ">
                        <label
            ...
            <div class="card card-warning">
                <div class="card-header">
                    <h3 class="card-title">Customer Info Old</h3>
                </div>
                <div class="card-body">
                    <div class="form-group">
                        <label
    ...
    <div class="row pb-5">
        <div class="col-12">
            <input type="submit" value="Overriding Customer" class="btn btn-success float-right">
        </div>
    </div>
@endsection
